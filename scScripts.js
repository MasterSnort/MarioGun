...
window.onload = function() {
    ...
    background.src="images/bg.jpg";
      var ship1 = new Image();
    ship1.src="images/GunGun.png"
    var ship2 = new Image();
    ship2.src="images/MarioGun.png"
    var block = new Image();
    ...
    if (starArray[i].visible()){
                ...
                if (Math.abs(p1x-starArray[i]._x)<20 & Math.abs(p1y-starArray[i]._y)<20) {scoring(i,2);}
                if (Math.abs(p2x-starArray[i]._x)<20 & Math.abs(p2y-starArray[i]._y)<20) {scoring(i,1);}
